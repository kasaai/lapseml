...
\Author{Kevin Kuo$^{1}$\href{https://orcid.org/0000-0001-7803-7901}{\orcidicon}, Frankie Logan$^{2}$, Bob Crompton$^{3}$}

% Authors, for metadata in PDF
\AuthorNames{Kevin Kuo, Frankie Logan, Bob Crompton}
...
$^{3}$ \quad Actuarial Resources Corporation of Georgia, Alpharetta, GA, USA; \href{mailto:bob.crompton@arcga.com}{\nolinkurl{bob.crompton@arcga.com}}\\
}
...
Discuss data from \citet{soa2010}
...
Discuss model from \citet{soa2015}.
